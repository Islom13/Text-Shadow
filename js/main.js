function textShadow ({
	...
	// var cssStyles = offset_x + 'px ' + offset_y + 'px ' + font_size +
	// 'px ' + blur + 'px ' + rgba;
	// $('.title').css('textShadow', cssStyles);
	// $('#resultHex').val('background-color: ' +color+ ';\nopacity:'+opacity+ ';'
	//  + '\nfont-size:' + font_size + 'px;');
	
	// $('#resultRgba').val('text-shadow: '+offset_x+ 'px ' + offset_y + 'px' + blur 
	// 	+ 'px;\n' + rgba + ' ;\nfont-size:' + font_size + 'px ;');
	...
	$('.title').css('fontSize', font_size+'px ');
	textShadow({
		font_size:font_size,
		offset_x:offset_x,
		offset_y:offset_y,
